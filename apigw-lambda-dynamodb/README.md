...
1. Delete the stack
    ```bash
    aws cloudformation delete-stack --stack-name caci-lambda-2023
    ```
1. Confirm the stack has been deleted
    ```bash
    aws cloudformation list-stacks --query "StackSummaries[?contains(StackName,'caci-lambda-2023')].StackStatus"
    ```
----
